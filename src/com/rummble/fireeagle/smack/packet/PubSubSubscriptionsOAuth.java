...
public class PubSubSubscriptionsOAuth extends IQ {

	private static Logger logger = Logger.getLogger(PubSubSubscriptionsOAuth.class.getName());
	...
	public PubSubSubscriptionsOAuth()
	{
		
	}
	
	public PubSubSubscriptionsOAuth(JID from,JID to)
	{
	...
	public boolean createOauthElement(String consumerKey,String consumerSecret,String token,String tokenSecret)
	{
		try
		{
			...
			DefaultElement subscribe = new DefaultElement("subscriptions",subNS);
